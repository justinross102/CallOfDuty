...
A Neural Network which had our best test RMSE still overfit by a some degree. Using a MLP network we tuned the hyper parameters by using a grid search for hidden layers, activation, solver, alpha, and learning rate. The final hyper parameters used were
activation: tanh
alpha: 0.01
hidden_layer_sizes: (100,)
learning_rate: adaptive
solver: sgd
Overall the model took longer to run than some of the others but it was our best model with a test RMSE of 49.91
